// Simple script to clean and seed grants
...
async function cleanAndSeedGrants() {
  try {
    console.log('🔌 Connecting to MongoDB...')
    
    // Use hardcoded URI to avoid dotenv issues
    const MONGODB_URI = 'mongodb+srv://dbuser:Tsunade%40106@cluster0.eshla4d.mongodb.net/gjts_karnataka?retryWrites=true&w=majority'
    
    await mongoose.connect(MONGODB_URI)
    console.log('✅ Connected to MongoDB')

    // Delete ALL grants
    const result = await Grant.deleteMany({})
    console.log(`🗑️  Deleted ${result.deletedCount} existing grants`)
    ...
    const grants = [
      {
        ...
        amount: { min: 500000, max: 5000000, currency: 'INR' },
      ...
      },
      {
        ...
        grantProvider: 'Ministry of Education, Government of India',
        providerType: 'government',
        amount: { min: 2000000, max: 10000000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 5000000, max: 20000000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 500000, max: 1500000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 800000, max: 1200000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 300000, max: 700000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 1000000, max: 2000000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 200000, max: 400000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 500000, max: 1000000, currency: 'INR' },
      ...
      },
      {
        ...
        providerType: 'government',
        amount: { min: 800000, max: 1500000, currency: 'INR' },
    ...
    const inserted = await Grant.insertMany(grants)
    console.log(`✅ Inserted ${inserted.length} clean grants`)

    console.log('\n📊 Grant Summary:')
    grants.forEach((g, i) => {
      console.log(`   ${i + 1}. ${g.title}`)
      console.log(`      Per School: ${g.perSchoolAmount}`)
    })

    console.log('\n✅ Database cleaned and seeded successfully!')
    console.log('🎉 All gibberish grants removed!')
